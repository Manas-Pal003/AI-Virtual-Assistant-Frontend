...
const Customize = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-white relative overflow-y-auto px-4 py-12 flex flex-col items-center justify-center animate-fade-in">
      ...
      <form
        ...
        className="relative w-full max-w-6xl rounded-[34px] bg-slate-900/40 border border-white/10 backdrop-blur-2xl shadow-2xl p-6 sm:p-8 lg:p-10"
      >
        {/* Header section */}
        <div className="text-center max-w-3xl mx-auto mb-10">
          <span className="inline-flex items-center rounded-full bg-cyan-500/10 border border-cyan-500/20 px-5 py-2 text-sm text-cyan-300 mb-5 font-medium tracking-wide">
            <Sparkles size={14} className="mr-2 text-cyan-400 animate-pulse" />
        ...
        <div className="max-w-xl mx-auto mb-12">
          <label className="block text-sm font-semibold text-slate-300 mb-3 tracking-wide text-center">
            Assistant Name
          </label>

          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
              <Bot size={20} className="text-slate-500 group-focus-within:text-cyan-400 transition-colors duration-300" />
            </div>
            <input
              type="text"
              value={assistantName}
              ...
              className="w-full h-[58px] pl-12 pr-5 rounded-2xl border border-white/10 bg-white/5 text-white placeholder-slate-500 outline-none focus:border-cyan-500 focus:bg-white/10 focus:ring-4 focus:ring-cyan-500/10 transition-all duration-300 text-center text-lg"
            />
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6 border-b border-white/5 pb-4">
            <div>
              <h2 className="text-2xl font-bold tracking-tight">Select Avatar</h2>
            ...
            {previewImage && (
              <div className="flex items-center gap-3 rounded-2xl bg-white/5 border border-white/10 px-4 py-2.5 backdrop-blur-md shadow-lg shrink-0">
                <img
                  src={previewImage}
                ...
                />
                <div>
                  <p className="text-[10px] uppercase tracking-wider text-slate-400 font-semibold">Selected Assistant</p>
            ...
            {assistantImages.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/95 via-black/40 to-transparent text-left">
                    <p className="text-lg font-bold text-white tracking-tight">{item.name}</p>
                    <p className="text-xs text-white/60 mt-0.5">Select preset</p>
                  </div>

                  {isActive && (
                    <span className="absolute top-3 right-3 w-8 h-8 rounded-full bg-cyan-500 text-white flex items-center justify-center shadow-lg border border-white/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8 items-stretch border-t border-white/5 pt-10">
          <div>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-stretch">
              <label className="cursor-pointer flex flex-col md:flex-row items-center justify-center gap-4 flex-1 min-h-[140px] px-6 rounded-2xl border-2 border-dashed border-white/10 bg-white/5 hover:bg-white/10 hover:border-cyan-400 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl bg-cyan-500/10 flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500/20 group-hover:scale-110 transition duration-300">
                  <ImagePlus size={24} />
                </div>
              ...
              {customPreview && (
                <div className="relative overflow-hidden rounded-2xl border-2 border-cyan-400 bg-cyan-950/20 shadow-[0_0_20px_rgba(34,211,238,0.15)] flex flex-col w-full md:w-[130px] aspect-[3/4] shrink-0 group">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black/95 to-transparent text-left">
