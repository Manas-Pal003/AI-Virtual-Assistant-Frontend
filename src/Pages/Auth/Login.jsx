...
const Login = () => {
  ...
  const handleGoogleLoginClick = () => {
    if (!window.google) {
      showError("Google Identity Services script is not loaded yet. Please try again in a moment.");
      return;
    }

    try {
      const tokenClient = window.google.accounts.oauth2.initTokenClient({
        client_id: "548461515610-o5rim24eag8hu9itp8krjgkuler3udap.apps.googleusercontent.com",
        ...
        callback: async (tokenResponse) => {
          if (tokenResponse && tokenResponse.access_token) {
            ...
            try {
              ...
              const hasAssistantProfile = res.data.user.assistantName && res.data.user.assistantImage;
      ...
      showError("Could not start Google Sign-In. Please check your browser console.");
    }
  };
